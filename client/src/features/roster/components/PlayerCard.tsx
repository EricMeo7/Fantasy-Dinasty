            ...
            <div className="bg-slate-950/80 rounded-2xl p-4 border border-white/5 shadow-inner mb-6">
                <div className="flex justify-between items-center mb-4">
                    <span className="text-[9px] font-black text-slate-600 uppercase tracking-[0.2em] flex items-center gap-1.5 font-bold">
                        <TrendingUp size={12} className="text-emerald-500" /> Active Contract
                    </span>
                    <span className="text-[9px] font-black text-emerald-500/80 uppercase tracking-widest">Market Value</span>
                </div>
                ...
                <div className="flex justify-between items-end">
                    <div>
                        ...
                        <div className="text-[9px] font-black text-slate-700 uppercase tracking-widest mt-1">Season 24/25 CAP</div>
                    </div>
                    <div className="flex flex-col items-end gap-1">
                        <div className="flex items-center gap-2">
                            <span className="text-[9px] font-black text-slate-700 uppercase">Y2:</span>
                            <span className="text-xs font-black font-mono text-slate-400">{player.salaryYear2 > 0 ? player.salaryYear2.toFixed(1) : '-'} M</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="text-[9px] font-black text-slate-700 uppercase">Y3:</span>
